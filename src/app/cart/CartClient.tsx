...
const CartClient = () => {
  ...
  const increaseCart = (cart: ICartItems) => {
    console.log(cart)
    dispatch(INCREASE_CART(cart))
  }

  const decreaseCart = (cart: ICartItems) => {
    dispatch(DECREASE_CART(cart))
  }

  const removeFromCart = (cart: ICartItems) => {
      ...
      {cartItems.length === 0 ? (
        ...
        <>
          <table>
            ...
            <tbody>
              {cartItems.map((cart: ICartItems, index: number) => {
          ...
          <div className={styles.summary}>
            ...
            <div className={styles.checkout}>
              ...
              <div className={styles.text}>
                <h4>합계</h4>
                <p>{priceFormat(cartTotalAmt)}원</p>
              </div>
